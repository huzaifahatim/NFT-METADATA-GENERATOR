...
const addRarity = () => {
  ...
  const tolerance = 15;
  const rareColorBase = "NOT a FACE";
  const rareColor = [
    { name: "FACE", rgb: { r: 192, g: 158, b: 131 } },
    { name: "FACE", rgb: { r: 128, g: 134, b: 90 } },
    { name: "FACE", rgb: { r: 113, g: 65, b: 179 } },
    { name: "FACE", rgb: { r: 162, g: 108, b: 67 } },
  ];
